...
export class UiVisualsService {
  ...
  // metodo alternativo para obtener la ruta del asset de la bandera, en caso de querer usar imagenes en lugar de emojis
  getTeamFlagAssetPath(teamId?: string | null): string {
    const normalizedTeamId = (teamId ?? '').trim().toLowerCase();
    ...
    return `assets/flags/${normalizedTeamId}.png`;
  }

...
export class AppComponent implements OnInit {
  ...
  private readonly routeLabels: Record<string, string> = {
    ...
    'route.myTeam.rivals.subtitle': 'Rivales principales de la seleccion',
    ...
    'route.worldCup.history.subtitle': 'Resumen de mundiales históricos',
  ...
  get teamFlag(): string {
    return this.uiVisualsService.getTeamFlagAssetPath(this.teamId);
  }

...
| --- | ---------------- | --------------------------------------------- | ---------- |
| 1   | Facundo Ferrelli | Cuerpo Técnico y Estrategia                   | Mi Equipo  |
| 2   | Emiliano Vera    | Rivales Históricos                            | Mi Equipo  |
| 3   | Agustina Torres  | Fase de Grupos                                | El Mundial |
| 4   | Francisco Meglia | Camino del Equipo                             | El Mundial |
| 5   | Isidro Ferrero   | Detalles de Partidos                          | El Mundial |
| 6   | Pinto Juan       | Estadísticas y Premios                        | El Mundial |
| 7   | Maximiliano Diaz | Historial de Mundiales                        | El Mundial |
| 8   | Alan Migliore    | Eventos en Vivo                               | La Final   |
| 9   | Facundo Varela   | Estado del Equipo en la Final                 | La Final   |
| 10  | Facundo Varela   | **Jugar la Final** _(Responsabilidad Grupal)_ | La Final   |
